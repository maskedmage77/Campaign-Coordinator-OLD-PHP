<?php
    ...
    $sql = "INSERT INTO spells (spell_author, spell_name, spell_school, spell_ritual, spell_level, spell_time, spell_range, spell_components, spell_duration, spell_description, spell_source) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    // runs the prepared statement
        ...
        echo 'sending';
        mysqli_stmt_bind_param($stmt, "issiissssss", $spell_author, $spell_name, $spell_school, $spell_ritual, $spell_level, $spell_time, $spell_range, $spell_components, $spell_duration, $spell_description, $spell_source);
        mysqli_stmt_execute($stmt);
        //this will now add the spells classes to the database
        $sql1 = "INSERT INTO spells_class (spell_id, bard, cleric, druid, paladin, ranger, sorcerer, warlock, wizard)
            SELECT spell_id, ?, ?, ?, ?, ?, ?, ?, ? FROM spells ORDER BY spell_id DESC LIMIT 1";
        ...
        // runs the prepared statement
            ...
            mysqli_stmt_bind_param($stmt2, "iiiiiiii", $bard, $cleric, $druid, $paladin, $ranger, $sorcerer, $warlock, $wizard);
